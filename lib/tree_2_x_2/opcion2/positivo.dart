...
class Positiva_2_2_X_2 extends StatefulWidget {
  String idVideo;
  String tipo;
  Positiva_2_2_X_2(this.idVideo,this.tipo);
  @override
  _Positiva_2_2_X_2State createState() => _Positiva_2_2_X_2State(this.idVideo,this.tipo);
}

class _Positiva_2_2_X_2State extends State<Positiva_2_2_X_2> with SingleTickerProviderStateMixin {

  VideoPlayerController _controllervideo;

  _Positiva_2_2_X_2State(String idVideo ,String tipo );
  ...
  void initState() {
    ...
    Firestore.instance
        ...
        .document(widget.idVideo).collection('0').document('2_positivo')
