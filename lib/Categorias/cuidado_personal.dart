...
class Cpersonal extends StatefulWidget {
  @override
  _CpersonalState createState() => _CpersonalState();
}
class _CpersonalState extends State<Cpersonal> {
  var product_list;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('CUIDADO PERSONAL',style: TextStyle(
            color: Colors.black,
